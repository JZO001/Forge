namespace Testing.TerraGraf.RemotingService
{
    ...
    public abstract class TestContractStreamAbstractServiceProxy : Forge.Net.Remoting.Proxy.ProxyBase, Testing.TerraGraf.Contracts.ITestContractStream
    {
        ...
        public void SendImage(System.IO.Stream _p0)
        {
            ...
            try
            {
                ...
                Forge.Net.Remoting.Messaging.RequestMessage _message = new Forge.Net.Remoting.Messaging.RequestMessage(System.Guid.NewGuid().ToString(), Forge.Net.Remoting.MessageTypeEnum.Request, Forge.Net.Remoting.MessageInvokeModeEnum.RequestCallback, typeof(Testing.TerraGraf.Contracts.ITestContractStream), "SendImage", _mps);
                _message.Context.Add(Forge.Net.Remoting.Proxy.ProxyBase.PROXY_ID, Forge.Net.Remoting.ServiceBase.GetPeerProxyId(this));

                long _timeout = GetTimeoutByMethod(typeof(Testing.TerraGraf.Contracts.ITestContractStream), "SendImage", _mps, Forge.Net.Remoting.Proxy.MethodTimeoutEnum.CallTimeout);
