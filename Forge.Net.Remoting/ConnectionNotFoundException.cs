...
namespace Forge.Net.Remoting
{
    ...
    public class ConnectionNotFoundException : Exception
    {
        ...
        public ConnectionNotFoundException(string message, Exception ex) : base(message, ex)
        {
        }
        ...
        protected ConnectionNotFoundException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
