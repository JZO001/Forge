...
namespace Forge.Net.Remoting.Sinks
{
    ...
    /// </summary>
    public sealed class BinarySerializerMessageSink : MessageSinkBase
    {

        #region Field(s)

        private static readonly string BINARY_MESSAGE_SINK_ID = "309E394E-8FD9-439D-B594-7F654B817BC4";

        private readonly BinarySerializerFormatter<IMessage> mFormatter = new BinarySerializerFormatter<IMessage>(BinarySerializerBehaviorEnum.DoNotThrowExceptionOnMissingField, TypeLookupModeEnum.AllowAll, true);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BinarySerializerMessageSink"/> class.
        /// </summary>
