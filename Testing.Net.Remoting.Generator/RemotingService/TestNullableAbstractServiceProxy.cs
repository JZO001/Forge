namespace Testing.Net.Remoting.Generator.RemotingService
{
    ...
    public abstract class TestNullableAbstractServiceProxy : Forge.Net.Remoting.Proxy.ProxyBase, Testing.Net.Remoting.Generator.Contracts.ITestNullable
    {

        protected TestNullableAbstractServiceProxy(Forge.Net.Remoting.Channels.Channel channel, System.String sessionId) : base(channel, sessionId) { }

        public abstract System.Boolean GetValue(System.Boolean? isCheck);

        [System.Diagnostics.DebuggerStepThroughAttribute]
        public System.Boolean SendValue(System.Boolean? isCheck)
        {
            DoDisposeCheck();
            ...
            try
            {
                ...
                Forge.Net.Remoting.Messaging.RequestMessage _message = new Forge.Net.Remoting.Messaging.RequestMessage(System.Guid.NewGuid().ToString(), Forge.Net.Remoting.MessageTypeEnum.Request, Forge.Net.Remoting.MessageInvokeModeEnum.RequestCallback, typeof(Testing.Net.Remoting.Generator.Contracts.ITestNullable), "SendValue", _mps, false);
                _message.Context.Add(Forge.Net.Remoting.Proxy.ProxyBase.PROXY_ID, Forge.Net.Remoting.ServiceBase.GetPeerProxyId(this));

                long _timeout = GetTimeoutByMethod(typeof(Testing.Net.Remoting.Generator.Contracts.ITestNullable), "SendValue", _mps, Forge.Net.Remoting.Proxy.MethodTimeoutEnum.CallTimeout);
