namespace Testing.Net.Remoting.Generator.RemotingClient
{
    ...
    public abstract class TestContractStreamAbstractClientProxy : Forge.Net.Remoting.Proxy.ProxyBase, Testing.Net.Remoting.Generator.Contracts.ITestContractStream
    {
        ...
        public System.String GetName()
        {
            ...
            try
            {
                ...
                Forge.Net.Remoting.Messaging.RequestMessage _message = new Forge.Net.Remoting.Messaging.RequestMessage(System.Guid.NewGuid().ToString(), Forge.Net.Remoting.MessageTypeEnum.Request, Forge.Net.Remoting.MessageInvokeModeEnum.RequestService, typeof(Testing.Net.Remoting.Generator.Contracts.ITestContractStream), "GetName", _mps, false);
                _message.Context.Add(Forge.Net.Remoting.Proxy.ProxyBase.PROXY_ID, this.ProxyId);

                long _timeout = GetTimeoutByMethod(typeof(Testing.Net.Remoting.Generator.Contracts.ITestContractStream), "GetName", _mps, Forge.Net.Remoting.Proxy.MethodTimeoutEnum.CallTimeout);
        ...
        public void SayHello()
        {
            ...
            try
            {
                ...
                Forge.Net.Remoting.Messaging.RequestMessage _message = new Forge.Net.Remoting.Messaging.RequestMessage(System.Guid.NewGuid().ToString(), Forge.Net.Remoting.MessageTypeEnum.Datagram, Forge.Net.Remoting.MessageInvokeModeEnum.RequestService, typeof(Testing.Net.Remoting.Generator.Contracts.ITestContractStream), "SayHello", _mps, false);
                _message.Context.Add(Forge.Net.Remoting.Proxy.ProxyBase.PROXY_ID, this.ProxyId);

                long _timeout = GetTimeoutByMethod(typeof(Testing.Net.Remoting.Generator.Contracts.ITestContractStream), "SayHello", _mps, Forge.Net.Remoting.Proxy.MethodTimeoutEnum.CallTimeout);
