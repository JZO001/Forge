...
namespace Forge.ORM.NHibernateExtension
{
    ...
    /// </summary>
    [Serializable]
    public class EntitySaveException : ORMException
    {

        #region Constructor(s)

        /// <summary>
        /// Initializes a new instance of the <see cref="EntitySaveException"/> class.
        /// </summary>
        ...
        protected EntitySaveException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
